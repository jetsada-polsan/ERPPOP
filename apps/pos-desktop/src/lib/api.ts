...
export const api = {
  ...
  cashierLogin: (code: string, pin: string) => request<{ cashier: Cashier; must_change_pin: boolean; offline_credential?: Cashier['offline_credential'] }>('/cashier/login', { method: 'POST', body: JSON.stringify({ code, pin }) }),
