...
.org-people-modal{width:min(680px,calc(100vw - 28px));max-height:min(76vh,720px);overflow:hidden}.org-people-modal section{display:flex;flex-direction:column;max-height:min(76vh,720px)}.org-people-modal .modal-header small{display:block;margin-top:2px;color:#718697;font-size:11px}.org-people-positions{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px;padding:10px 14px;background:#f3f8fb;border-bottom:1px solid #dae6ed}.org-people-positions span{display:flex;justify-content:space-between;gap:8px;padding:7px 9px;border:1px solid #d4e2eb;border-radius:7px;background:#fff;color:#476275;font-size:11px}.org-people-positions span.vacant{border-color:#f0d7a5;background:#fff8e9;color:#a96416}.org-people-list{padding:8px 14px 14px;overflow-y:auto}.org-person-row{display:grid;grid-template-columns:34px minmax(0,1fr) auto;align-items:center;gap:10px;padding:8px 4px;border-bottom:1px solid var(--erp-surface-2);text-align:left}.org-person-avatar{display:grid;place-items:center;width:32px;height:32px;border-radius:9px;background:#e4f4fc;color:#1386c1;font-weight:800}.org-person-row b,.org-person-row small{display:block}.org-person-row b{color:var(--erp-primary-dark);font-size:13px}.org-person-row small{margin-top:2px;color:#7a8e9c;font-size:10.5px}.org-person-branch{padding:3px 7px;border-radius:10px;background:#edf4f8;color:#567083;font-size:10px}.org-people-empty{display:grid;justify-items:center;gap:4px;padding:34px;color:#8a9ba8}.org-people-empty i{font-size:28px}.org-people-empty small{font-size:11px}@media(max-width:560px){.org-people-positions{grid-template-columns:1fr}}
