...
@push('head')
<style>
.org-toolbar{display:flex;align-items:center;gap:10px}.org-tabs,.org-view-switch{display:flex;padding:3px;background:var(--erp-success-soft);border-radius:8px}.org-tabs button,.org-view-switch button{border:0;background:transparent;padding:7px 14px;border-radius:6px;color:var(--erp-muted);font-weight:700}.org-tabs button.active,.org-view-switch button.active{background:#fff;color:var(--erp-primary);box-shadow:0 2px 7px rgba(15,23,42,.1)}.org-card{overflow:hidden}.org-head,.org-row summary{display:grid;grid-template-columns:minmax(280px,1.4fr) 100px 190px minmax(180px,1fr) 80px 28px;align-items:center;gap:8px}.org-head{padding:8px 12px;background:var(--erp-primary-soft);color:var(--erp-muted);font-size:12px;font-weight:800}.org-row{border-top:1px solid var(--erp-border)}.org-row summary{padding:8px 12px;cursor:pointer;list-style:none}.org-row summary:hover{background:var(--erp-surface-2)}.org-name{padding-left:calc(var(--level)*22px);display:flex;align-items:center;gap:7px}.org-name i{color:var(--erp-primary-ink)}.org-name small,.org-card td small{display:block;color:#8091a0;font-size:11px}.org-edit{display:grid;grid-template-columns:130px 1fr 140px 1fr;gap:8px;padding:12px 20px;background:var(--erp-surface-2);border-top:1px dashed var(--erp-border)}.org-edit label,.org-form label{color:var(--erp-muted);font-size:12px;font-weight:700}.org-edit .wide{grid-column:1/-1}.org-check{display:flex!important;align-items:center;gap:6px}.org-actions{display:flex;justify-content:flex-end}.org-modal{width:min(640px,calc(100vw - 30px))}.org-form{display:grid;grid-template-columns:1fr 1fr;gap:10px}.org-form label{display:grid;gap:4px}
.org-tree-card{padding:0;overflow:hidden;max-width:100%}.org-tree-help{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:7px 12px;border-bottom:1px solid var(--erp-border);background:var(--erp-surface-2);color:var(--erp-muted);font-size:12px}.org-tree-pan{display:flex;align-items:center;gap:6px;white-space:nowrap}.org-tree-pan b{font-size:11px}.org-tree-pan button{width:30px;height:28px;border:1px solid var(--erp-border);border-radius:6px;background:#fff;color:var(--erp-primary)}.org-tree-pan button:hover{background:var(--erp-primary-soft)}.org-tree-scroll{width:100%;max-width:100%;overflow-x:scroll;overflow-y:hidden;padding-bottom:8px;scrollbar-gutter:stable;scrollbar-color:#7fa9c2 var(--erp-border)}.org-tree-scroll::-webkit-scrollbar{height:13px}.org-tree-scroll::-webkit-scrollbar-track{background:var(--erp-border)}.org-tree-scroll::-webkit-scrollbar-thumb{border:3px solid var(--erp-border);border-radius:10px;background:#7fa9c2}.org-tree{width:max-content;min-width:100%;padding:24px 20px 28px}.org-tree ul{position:relative;display:flex;justify-content:center;margin:0;padding-top:24px;padding-left:0}.org-tree li{position:relative;list-style:none;text-align:center;padding:24px 7px 0}.org-tree>ul>li{padding-top:0}.org-tree li::before,.org-tree li::after{content:'';position:absolute;top:0;width:50%;height:24px;border-top:1px solid #9bb5c6}.org-tree li::before{right:50%;border-right:1px solid #9bb5c6}.org-tree li::after{left:50%;border-left:1px solid #9bb5c6}.org-tree li:only-child::before,.org-tree li:only-child::after{display:none}.org-tree li:first-child::before,.org-tree li:last-child::after{border:0}.org-tree li:last-child::before{border-radius:0 6px 0 0}.org-tree li:first-child::after{border-radius:6px 0 0}.org-tree ul ul::before{content:'';position:absolute;top:0;left:50%;height:24px;border-left:1px solid #9bb5c6}.org-tree>ul::before,.org-tree>ul>li::before,.org-tree>ul>li::after{display:none}.org-tree-node{width:160px;min-height:94px;padding:9px;border:1px solid var(--erp-border);border-radius:9px;background:#fff;color:var(--erp-primary-dark);box-shadow:0 4px 12px rgba(15,51,74,.07);transition:.15s}.org-tree-node:hover{transform:translateY(-2px);border-color:#4aaddc;box-shadow:0 7px 18px rgba(15,51,74,.13)}.org-tree-node.type-company{border-top:4px solid var(--erp-primary)}.org-tree-node.type-management{border-top:4px solid #7357c7}.org-tree-icon{display:grid;place-items:center;width:27px;height:27px;margin:0 auto 5px;border-radius:7px;background:var(--erp-primary-soft);color:var(--erp-primary)}.org-tree-node strong,.org-tree-node small,.org-tree-manager{display:block}.org-tree-node strong{font-size:13px}.org-tree-node small{margin-top:2px;color:var(--erp-muted);font-size:10px}.org-tree-manager{margin-top:6px;padding-top:5px;border-top:1px solid var(--erp-surface-2);color:var(--erp-muted);font-size:9.5px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
...
.org-tree-positions{display:block;margin-top:5px;padding-top:4px;border-top:1px dashed var(--erp-border)}.org-tree-positions em{display:block;padding:2px 3px;color:var(--erp-muted);font-size:9px;font-style:normal;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.org-tree-positions em.vacant{color:var(--erp-warning-ink);background:var(--erp-warning-soft);border-radius:4px}
.org-people-modal{width:min(680px,calc(100vw - 28px));max-height:min(76vh,720px);overflow:hidden}.org-people-modal section{display:flex;flex-direction:column;max-height:min(76vh,720px)}.org-people-modal .modal-header small{display:block;margin-top:2px;color:var(--erp-muted);font-size:11px}.org-people-positions{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px;padding:10px 14px;background:var(--erp-surface-2);border-bottom:1px solid var(--erp-border)}.org-people-positions span{display:flex;justify-content:space-between;gap:8px;padding:7px 9px;border:1px solid var(--erp-border);border-radius:7px;background:#fff;color:var(--erp-muted);font-size:11px}.org-people-positions span.vacant{border-color:#f0d7a5;background:var(--erp-warning-soft);color:var(--erp-warning-ink)}.org-people-list{padding:8px 14px 14px;overflow-y:auto}.org-person-row{display:grid;grid-template-columns:34px minmax(0,1fr) auto;align-items:center;gap:10px;padding:8px 4px;border-bottom:1px solid var(--erp-surface-2);text-align:left}.org-person-avatar{display:grid;place-items:center;width:32px;height:32px;border-radius:9px;background:var(--erp-primary-soft);color:var(--erp-primary-ink);font-weight:800}.org-person-row b,.org-person-row small{display:block}.org-person-row b{color:var(--erp-primary-dark);font-size:13px}.org-person-row small{margin-top:2px;color:#7a8e9c;font-size:10.5px}.org-person-branch{padding:3px 7px;border-radius:10px;background:var(--erp-primary-soft);color:var(--erp-muted);font-size:10px}.org-people-empty{display:grid;justify-items:center;gap:4px;padding:34px;color:#8a9ba8}.org-people-empty i{font-size:28px}.org-people-empty small{font-size:11px}@media(max-width:560px){.org-people-positions{grid-template-columns:1fr}}
.org-people-dialog{width:min(680px,calc(100vw - 28px));max-height:min(76vh,720px);padding:0;border:0;border-radius:12px;background:#fff;box-shadow:0 22px 70px rgba(8,30,48,.3)}.org-people-dialog::backdrop{background:rgba(17,40,58,.58);backdrop-filter:blur(3px)}.org-people-dialog-card{display:flex;flex-direction:column;max-height:min(76vh,720px)}.org-people-dialog .modal-header small{display:block;margin-top:2px;color:var(--erp-muted);font-size:11px}
</style>
@endpush
