...
.employee-summary{display:grid;grid-template-columns:repeat(4,1fr);gap:10px}.employee-summary div{padding:12px 14px;border:1px solid #dbe5ed;border-radius:9px;background:#fff;box-shadow:0 3px 10px rgba(15,23,42,.04)}.employee-summary span{display:block;color:var(--erp-muted);font-size:10.5px}.employee-summary strong{display:block;margin-top:3px;color:#12344d;font-size:21px}.employee-filter{display:grid;grid-template-columns:minmax(260px,1fr) 210px 230px auto auto;gap:8px}.employee-card{overflow:hidden}.employee-table thead th{background:#eef5f9;color:var(--erp-primary-dark)}.employee-table td{font-size:11.5px}.employee-table td small{display:block;color:#7a8c9c;font-size:9.5px!important;margin-top:2px}.employee-table .code{color:#087fb9;font-weight:800}.mono{font-family:Consolas,monospace}.branch-ok,.user-linked{color:var(--erp-success-ink);font-weight:700}.branch-wait{display:inline-block;padding:2px 5px;border-radius:4px;background:#fff7ed;color:#c2410c;font-size:9.5px;font-weight:700}@media(max-width:1000px){.employee-summary{grid-template-columns:1fr 1fr}.employee-filter{grid-template-columns:1fr 1fr}.employee-filter .input-group{grid-column:1/-1}}@media(max-width:600px){.employee-summary,.employee-filter{grid-template-columns:1fr}}
</style>
@endpush
