...
.module-control-shell{display:grid;gap:12px;max-width:1500px;min-width:0;margin:auto}.module-control-shell>section,.module-control-shell .content-card,.module-control-shell .table-responsive{min-width:0;max-width:100%}.module-head{display:flex;justify-content:space-between;align-items:flex-start;gap:16px;min-width:0;padding:16px 18px;border:1px solid var(--erp-border);background:#fff;overflow:hidden}.module-head>div:first-child{min-width:0}.module-head h2{margin:0;color:var(--erp-text);font-size:20px;font-weight:900;overflow-wrap:anywhere}.module-head p{max-width:900px;margin:4px 0 0;color:var(--erp-muted);font-size:12px;overflow-wrap:anywhere}.control-tabs,.taxonomy-tabs{display:flex;gap:4px;max-width:100%;padding:4px;border:1px solid var(--erp-border);background:var(--erp-primary-soft);overflow-x:auto}.control-tabs button,.taxonomy-tabs button{border:0;background:transparent;padding:8px 13px;color:var(--erp-muted);font-size:12px;font-weight:800;white-space:nowrap}.control-tabs button.active,.taxonomy-tabs button.active{background:#fff;color:var(--erp-primary-ink);box-shadow:0 2px 7px rgba(24,67,95,.1)}.control-summary{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin-bottom:10px}.control-summary div{padding:10px 12px;border-left:3px solid var(--erp-primary);background:#fff}.control-summary span,.control-summary strong{display:block}.control-summary span{color:var(--erp-muted);font-size:10px}.control-summary strong{color:var(--erp-text);font-size:18px}.module-table{min-width:900px}.module-table th,.taxonomy-table th{background:var(--erp-primary-soft);color:var(--erp-muted);font-size:11px}.module-table td,.taxonomy-table td{color:var(--erp-primary-dark);font-size:11.5px}.action-badge{display:inline-block;padding:4px 7px;background:var(--erp-success-soft);color:var(--erp-info);font-weight:800}.open-module{display:grid;place-items:center;width:29px;height:29px;border:1px solid var(--erp-border);color:var(--erp-primary-ink)}.document-rule{display:flex;align-items:center;gap:10px;margin-bottom:10px;padding:11px 13px;border-left:4px solid var(--erp-success-ink);background:var(--erp-success-soft);color:var(--erp-success-ink)}.document-rule i{font-size:22px}.document-rule strong,.document-rule span{display:block}.document-rule span{font-size:11px}.taxonomy-tabs{margin-bottom:10px}.taxonomy-create{display:grid;grid-template-columns:160px 1fr 1fr auto;align-items:end;gap:8px;margin-bottom:10px;padding:11px;border:1px solid var(--erp-border);background:#fff}.taxonomy-create label{display:grid;gap:3px;color:var(--erp-muted);font-size:10px;font-weight:800}.taxonomy-create input,.taxonomy-table input{width:100%;height:32px;border:1px solid var(--erp-border);padding:4px 7px;color:var(--erp-primary-dark);font-size:12px}.taxonomy-table{min-width:760px}.taxonomy-actions{display:flex;justify-content:flex-end;gap:4px}.taxonomy-actions form{margin:0}.icon-action{display:grid;place-items:center;width:29px;height:29px;border:1px solid var(--erp-border);background:#fff}.icon-action.save{color:var(--erp-success-ink)}.icon-action.delete{color:var(--erp-danger)}.icon-action:disabled{opacity:.35}@media(max-width:760px){.control-summary{grid-template-columns:1fr}.taxonomy-create{grid-template-columns:1fr}.module-head{display:grid}.module-head>.d-flex{flex-wrap:wrap}}
</style>
@endpush
