...
<div class="row g-3 mb-3">
    ...
    <div class="col-md-4"><div class="metric-card metric-card-amber"><div class="metric-label">เอกสารที่ใช้กระทบยอด</div><div class="metric-value">฿{{ number_format($uniqueAmount, 2) }}</div><div class="metric-unit">{{ number_format($uniqueCount) }} เอกสาร · ไม่ใช่ยอดรายได้</div></div></div>
</div>
