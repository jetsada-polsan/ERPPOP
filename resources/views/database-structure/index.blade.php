...
<style>
    ...
    .db-overview-head p { margin: 0; color: var(--erp-muted); font-size: 12px; line-height: 1.5; }
    .db-engine { flex: 0 0 auto; padding: 7px 10px; border: 1px solid var(--erp-border); border-radius: 6px; color: var(--erp-primary-dark); background: var(--erp-surface-2); font: 700 11px Consolas, monospace; }
    ...
    .db-stat span { display: block; color: var(--erp-muted); font-size: 10px; font-weight: 800; }
    ...
    .db-search input, .db-module-select { width: 100%; height: 38px; border: 1px solid var(--erp-border); border-radius: 6px; color: var(--erp-text); background: #fff; font-size: 12px; }
    ...
    .db-table-link:hover { color: var(--erp-primary-ink); background: var(--erp-primary-soft); }
    .db-table-link.active { color: #fff; background: var(--erp-primary-ink); }
    .db-table-icon { width: 28px; height: 28px; display: grid; place-items: center; border-radius: 5px; color: var(--erp-primary-ink); background: var(--erp-primary-soft); }
    ...
    .db-table-link.active .db-table-name small { color: var(--erp-border); }
    ...
    .db-detail-label { margin: 5px 0 0; color: var(--erp-muted); font-size: 12px; }
    ...
    .db-module-blue, .db-module-cyan { color: var(--erp-primary-ink); background: var(--erp-primary-soft); }
    .db-module-teal { color: var(--erp-info); background: var(--erp-border); }
    .db-module-amber, .db-module-orange { color: var(--erp-warning-ink); background: var(--erp-warning-soft); }
    .db-module-red, .db-module-pink { color: var(--erp-danger); background: var(--erp-danger-soft); }
    .db-module-indigo { color: #4f46a5; background: var(--erp-primary-soft); }
    .db-module-slate, .db-module-brown { color: var(--erp-muted); background: var(--erp-primary-soft); }
    ...
    .db-meta-item strong { margin-top: 3px; overflow: hidden; color: var(--erp-text); font-size: 12px; text-overflow: ellipsis; white-space: nowrap; }
    ...
    .db-section-head h3 { margin: 0; color: var(--erp-text); font-size: 13px; font-weight: 900; }
    ...
    .db-relation-group h4 { margin: 0 0 8px; color: var(--erp-muted); font-size: 10px; font-weight: 900; }
    .db-relation-list { display: grid; gap: 6px; }
    .db-relation { display: grid; grid-template-columns: minmax(0, 1fr) auto; gap: 8px; align-items: center; padding: 8px 9px; border-left: 3px solid var(--erp-primary); background: var(--erp-surface-2); color: #3b5c70; text-decoration: none; }
    .db-relation:hover { color: var(--erp-primary-ink); background: var(--erp-primary-soft); }
    ...
    .db-none { padding: 10px; color: #8a9ca8; background: var(--erp-surface-2); font-size: 10px; text-align: center; }
    ...
    .db-columns th { padding: 9px 11px; color: var(--erp-muted); background: var(--erp-surface-2); border-bottom: 1px solid var(--erp-border); font-size: 9px; font-weight: 900; text-align: left; }
    .db-columns td { padding: 9px 11px; color: var(--erp-muted); border-bottom: 1px solid var(--erp-surface-2); font-size: 10px; vertical-align: top; }
    ...
    .db-key-pk { color: var(--erp-warning-ink); background: var(--erp-warning-soft); }
    .db-key-fk { color: var(--erp-primary-ink); background: var(--erp-primary-soft); }
    .db-key-uq { color: #5a4bb2; background: var(--erp-primary-soft); }
    .db-key-ai { color: var(--erp-success-ink); background: var(--erp-border); }
    .db-default { display: block; max-width: 220px; color: var(--erp-muted); font: 9px Consolas, monospace; white-space: normal; overflow-wrap: anywhere; }
    .db-index-list { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 7px; padding: 0 14px 14px; }
    .db-index { min-width: 0; padding: 9px 10px; border: 1px solid var(--erp-border); border-radius: 6px; }
    ...
    .db-index span { display: block; margin-top: 4px; color: var(--erp-muted); font-size: 9px; overflow-wrap: anywhere; }
    .db-legend { display: flex; gap: 10px; flex-wrap: wrap; padding: 11px 14px; color: var(--erp-muted); background: var(--erp-surface-2); font-size: 9px; }
