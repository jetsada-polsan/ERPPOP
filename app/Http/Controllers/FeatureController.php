...
class FeatureController extends Controller
{
    ...
    private function modules(): array
    {
        $modules = [
            ...
            [
                'key' => 'mrp-planning',
                'title' => 'MRP และวางแผนผลิต',
                'icon' => 'bi-diagram-3',
                'accent' => '#0f766e',
                'summary' => 'วางแผนจากยอดขายจริง สต๊อกคงเหลือ สูตรผลิต Lead time และของค้างรับ เพื่อเสนอการผลิต/จัดซื้อ',
                'items' => [
                    ['name' => 'คำนวณความต้องการสุทธิ (MRP)', 'status' => 'ready', 'route' => ['production.index', []], 'note' => 'พิจารณาสต๊อกพร้อมขาย ยอดจอง จุดสั่งซื้อ และของระหว่างทาง'],
                    ['name' => 'สูตรผลิตหลายเวอร์ชันและวันเริ่มมีผล', 'status' => 'ready', 'route' => ['production.index', []], 'note' => 'แยกสูตรตามช่วงเวลาและสินค้าหรือสาขา'],
                    ['name' => 'แผนผลิตและติดตามสถานะงาน', 'status' => 'ready', 'route' => ['production.index', []]],
                    ['name' => 'ต้นทุนจริงจากวัตถุดิบ Yield และของเสีย', 'status' => 'ready', 'route' => ['reports.index', ['category' => 'inventory', 'report' => 'stock_movements']]],
                ],
            ],
            [
                'key' => 'fixed-assets',
                'title' => 'ทรัพย์สินถาวร (FA)',
                'icon' => 'bi-building-gear',
                'accent' => '#7c3aed',
                'summary' => 'ทะเบียนทรัพย์สิน ค่าเสื่อมราคา โอนย้าย จำหน่าย และรายงานมูลค่าทรัพย์สินตามสาขา',
                'items' => [
                    ['name' => 'ทะเบียนทรัพย์สินและศูนย์ต้นทุน', 'status' => 'ready', 'route' => ['fixed-assets.index', []]],
                    ['name' => 'คำนวณค่าเสื่อมราคารายเดือน', 'status' => 'ready', 'route' => ['fixed-assets.index', []]],
                    ['name' => 'โอนย้ายและจำหน่ายทรัพย์สิน', 'status' => 'ready', 'route' => ['fixed-assets.index', []]],
                    ['name' => 'กระทบยอด FA กับบัญชีแยกประเภท', 'status' => 'ready', 'route' => ['financial-statements.index', []]],
                ],
            ],
            [
                'key' => 'accounting',
            ...
            [
                ...
                'title' => 'การเงินและ Treasury',
                'icon' => 'bi-bank2',
                'accent' => '#047857',
                'summary' => 'คุมเงินสด ธนาคาร เช็ค สเตตเมนต์ การโอนเงิน และกระทบยอดกับใบเสร็จ/เอกสารขาย',
                'items' => [
                    ['name' => 'บัญชีธนาคารและช่องทางรับเงิน', 'status' => 'ready', 'route' => ['bank-accounts.index', []]],
                    ['name' => 'นำเข้า Statement และตรวจรายการผิดปกติ', 'status' => 'ready', 'route' => ['monthly-accounting.index', []]],
                    ['name' => 'กระทบยอด Statement กับใบเสร็จ POS', 'status' => 'ready', 'route' => ['monthly-accounting.index', []], 'note' => 'จับคู่ยอดเงิน วันที่ เลขอ้างอิง และสาขา พร้อมสถานะรอตรวจ'],
                    ['name' => 'ทะเบียนเช็ครับ/เช็คจ่ายและสถานะเคลียร์', 'status' => 'ready', 'route' => ['cheques.index', []]],
                    ['name' => 'เงินสดย่อย ค่าใช้จ่าย และใบสำคัญจ่าย', 'status' => 'ready', 'route' => ['monthly-accounting.index', []]],
                ],
            ],
            [
                'key' => 'ap-ar-control',
                ...
                'accent' => '#b45309',
                'summary' => 'วงจรเจ้าหนี้และลูกหนี้ตั้งแต่เอกสารต้นทาง ใบวางบิล รับชำระ จนถึง Aging และวงเงินเครดิต',
                'items' => [
                    ['name' => 'เจ้าหนี้ AP และรายการครบกำหนดจ่าย', 'status' => 'ready', 'route' => ['suppliers.index', []]],
                    ['name' => 'สามทาง PO - ใบรับของ - ใบกำกับซื้อ', 'status' => 'ready', 'route' => ['purchases.index', []]],
                    ['name' => 'ลูกหนี้ AR และรายการครบกำหนดรับ', 'status' => 'ready', 'route' => ['customers.index', []]],
                    ['name' => 'ใบวางบิล รับชำระ และ Aging', 'status' => 'ready', 'route' => ['billing-notes.index', []]],
                    ['name' => 'ใบเพิ่มหนี้/ลดหนี้และผลกระทบภาษี', 'status' => 'ready', 'route' => ['credit-debit-notes.index', []]],
                ],
            ],
            [
                'key' => 'reports',
            ...
            [
                'key' => 'perpetual-control',
                'title' => 'Perpetual Cost Control',
                'icon' => 'bi-arrow-repeat',
                'accent' => '#0f766e',
                'summary' => 'เชื่อมเอกสารซื้อ ขาย รับเข้า ตัดสต๊อก ต้นทุน และ GL แบบตรวจสอบย้อนกลับได้',
                'items' => [
                    ['name' => 'ต้นทุน FIFO / FEFO และต้นทุนเฉลี่ยรายงวด', 'status' => 'ready', 'route' => ['products.index', []], 'note' => 'ไม่ย้อนแก้ต้นทุนขายที่เกิดแล้ว และดู Lot ต้นทางได้'],
                    ['name' => 'สามทาง PO - ใบรับของ - ใบกำกับซื้อ', 'status' => 'ready', 'route' => ['purchases.index', []], 'note' => 'แยกข้อยกเว้นราคา/จำนวนก่อนอนุมัติจ่าย'],
                    ['name' => 'กำไรจริงแยกสาขา สินค้า และช่องทาง', 'status' => 'ready', 'route' => ['reports.index', ['category' => 'sales', 'report' => 'sales_by_branch']]],
                    ['name' => 'ย้อนจากตัวเลขบัญชีกลับไปเอกสารต้นทาง', 'status' => 'ready', 'route' => ['gl-journals.index', []]],
                ],
            ],
            [
                'key' => 'business-intelligence',
                'title' => 'BI และ Control Tower',
                'icon' => 'bi-speedometer2',
                'accent' => '#2563eb',
                'summary' => 'แดชบอร์ดผู้บริหารพร้อม Drill-down จาก KPI ไปยังบิล สต๊อก เงินสด และกำไรของแต่ละสาขา',
                'items' => [
                    ['name' => 'ยอดขาย กำไร และสต๊อกแบบรวมทุกสาขา', 'status' => 'ready', 'route' => ['dashboard', []]],
                    ['name' => 'Drill-down จาก KPI ถึงเอกสารจริง', 'status' => 'ready', 'route' => ['reports.index', []]],
                    ['name' => 'แจ้งเตือนของหมดอายุ สต๊อกต่ำ และเงินผิดปกติ', 'status' => 'ready', 'route' => ['notifications.index', []]],
                    ['name' => 'Audit, Backup และสถานะการซิงก์ POS', 'status' => 'ready', 'route' => ['operations.index', []]],
                ],
            ],
            [
                'key' => 'online',
