...
class ManualController extends Controller
{
    ...
    /**
     * คู่มือใช้งานแต่ละหน้าจอ (ปุ่ม/การกระทำหลัก) - จัดกลุ่มตามเมนูจริงใน App\Support\ErpMenu
     * เพื่อให้พนักงานหาเจอตรงกับเมนูที่เห็นบนจอ ต่างจาก pillars() ที่เน้นสายข้อมูลเข้า-ออก
     * ระหว่างโปรแกรม เนื้อหานี้เน้น "ใช้ทำอะไร" และ "กดปุ่มไหนได้บ้าง" ต่อหน้าจอ
     */
    private function moduleGuide(): array
    {
        return [
            [
                'key' => 'overview', 'label' => 'ภาพรวม', 'icon' => 'bi-house-door-fill',
                'items' => [
                    ['label' => 'ภาพรวมกิจการ', 'route' => 'dashboard', 'purpose' => 'หน้าแรกสรุปยอดขาย เงินสด สต๊อก และงานค้างประจำวันแบบภาพรวม', 'actions' => ['หน้าดูอย่างเดียว ไม่มีปุ่มบันทึกข้อมูล', 'คลิกตัวเลข/กราฟเพื่อดูรายละเอียดเพิ่ม']],
                    ['label' => 'รวมเมนูการทำงาน', 'route' => 'features.index', 'purpose' => 'รวมลิงก์ลัดไปทุกฟีเจอร์ในระบบไว้ที่เดียว ช่วยหาเมนูที่ต้องการเร็วขึ้น', 'actions' => ['คลิกเปิดฟีเจอร์ที่ต้องการ (หน้าดูอย่างเดียว)']],
                    ['label' => 'คู่มือ PopStar 4M', 'route' => 'core-modules.index', 'purpose' => 'หน้าคู่มือรวมนี้เอง อธิบายภาพรวมระบบ ขั้นตอนงาน สูตรคำนวณ และจุดที่ยังต้องพัฒนา', 'actions' => ['ค้นหา/สลับหมวด 4M', 'ปุ่มพิมพ์คู่มือ', 'เปิดโปรแกรมจากลิงก์ในตาราง', 'ทำเครื่องหมายผลทดสอบ UAT (บันทึกในเครื่องตัวเองเท่านั้น)']],
                    ['label' => 'ศูนย์ควบคุมบริหาร', 'route' => 'management-controls.index', 'purpose' => 'ศูนย์รวมงานบริหาร: ศูนย์ต้นทุน งบประมาณ แผนจัดซื้อ เงินเดือน/บันทึกเวลา และรับออเดอร์ e-commerce', 'actions' => ['เพิ่มศูนย์ต้นทุน', 'ตั้งงบประมาณ + อนุมัติงบ', 'สร้างแผนจัดซื้ออัตโนมัติ', 'บันทึกเวลาเข้างาน', 'รันเงินเดือน → แก้ไขรายการ → อนุมัติ → จ่ายแล้ว → พิมพ์สลิป', 'นำเข้าออเดอร์จากช่องทาง e-commerce']],
                ],
            ],
            [
                'key' => 'daily', 'label' => 'งานประจำวัน (ขาย/เอกสาร)', 'icon' => 'bi-cash-coin',
                'items' => [
                    ['label' => 'เอกสารย้อนหลัง', 'route' => 'documents.browser', 'purpose' => 'ค้นหา/เรียกดูเอกสารเก่าทุกประเภท ทั้ง ERP ใหม่และ BPlus เดิม เป็นศูนย์กลางค้นเอกสารย้อนหลัง', 'actions' => ['ค้นหาตามเลขที่/วันที่/ประเภทเอกสาร', 'เปิดดู/พิมพ์ซ้ำเอกสาร (ไม่มีการแก้ไขเอกสารในหน้านี้)']],
                    ['label' => 'ใบเสนอราคา', 'route' => 'quotations.index', 'purpose' => 'ออกใบเสนอราคาให้ลูกค้าก่อนตัดสินใจซื้อ', 'actions' => ['สร้างใบเสนอราคาใหม่', 'เปลี่ยนสถานะ (เช่น ยืนยัน/ยกเลิก)', 'แปลงเป็นใบขาย/ใบจอง']],
                    ['label' => 'ใบจอง / ขายเชื่อ', 'route' => 'bookings.index', 'purpose' => 'จองสินค้าล่วงหน้าหรือขายเชื่อให้ลูกค้า - ระบบจะตรวจยอดสต๊อกพร้อมจองในสาขานั้นก่อนให้บันทึก', 'actions' => ['สร้างใบจอง/ใบขายเชื่อใหม่', 'แปลงใบจองเป็นใบขายจริง', 'บันทึกการส่งของ', 'ดูใบเก่าที่ยังอยู่ในระบบ BPlus เดิม']],
                    ['label' => 'ใบขายสด', 'route' => 'cash-sales.index', 'purpose' => 'บันทึกขายสดหน้าร้านนอกเหนือจากที่ขายผ่าน POS', 'actions' => ['สร้างใบขายสดใหม่', 'ดูรายละเอียดใบขาย']],
                    ['label' => 'ใบรับคืนสินค้า', 'route' => 'sale-returns.index', 'purpose' => 'รับคืนสินค้าจากลูกค้า อ้างอิงใบขายเดิม', 'actions' => ['สร้างใบรับคืนสินค้าใหม่']],
                    ['label' => 'ใบวางบิล', 'route' => 'billing-notes.index', 'purpose' => 'รวมยอดค้างชำระของลูกค้าเป็นใบวางบิลก่อนไปเก็บเงิน', 'actions' => ['ดึงรายการค้างชำระของลูกค้า', 'สร้างใบวางบิล', 'อัปเดตสถานะ เช่น รับชำระแล้ว']],
                    ['label' => 'ใบเพิ่ม/ลดหนี้', 'route' => 'credit-debit-notes.index', 'purpose' => 'ปรับยอดหนี้ลูกค้า/เจ้าหนี้ เช่น ให้ส่วนลดย้อนหลังหรือเก็บเงินเพิ่ม', 'actions' => ['สร้างใบเพิ่ม/ลดหนี้', 'อนุมัติ / ไม่อนุมัติ (ต้องมีสิทธิ์เฉพาะ ผู้สร้างอนุมัติเองไม่ได้)', 'พิมพ์ใบ']],
                    ['label' => 'ลูกค้าสัมพันธ์ (CRM)', 'route' => 'crm.index', 'purpose' => 'บันทึกกิจกรรมติดต่อลูกค้า เช่น โทร/นัดพบ', 'actions' => ['บันทึกกิจกรรมใหม่', 'ทำเครื่องหมายกิจกรรมว่าเสร็จแล้ว']],
                    ['label' => 'Pipeline งานขาย', 'route' => 'crm.pipeline', 'purpose' => 'ติดตามโอกาสการขาย (ดีล) เป็นขั้นตอนตั้งแต่ติดต่อจนปิดการขาย', 'actions' => ['เพิ่มโอกาสการขายใหม่', 'ลากเปลี่ยนขั้นตอน/สถานะของดีล']],
                ],
            ],
            [
                'key' => 'pos', 'label' => 'POS / หน้าร้าน', 'icon' => 'bi-shop-window',
                'items' => [
                    ['label' => 'เปิด POS ขาย', 'route' => 'pos.index', 'purpose' => 'หน้าขายหลักของแคชเชียร์ (เปิดในแท็บใหม่)', 'actions' => ['เปิดกะ (ระบุเงินทอนต้นกะ)', 'สแกน/เลือกสินค้าเข้าตะกร้า', 'พักบิล และเรียกบิลที่พักไว้กลับมา', 'เช็คเอาท์รับเงิน (เงินสด/โอน/บัตร/ผสม)', 'ยกเลิกใบเสร็จ (ต้องมีสิทธิ์ยกเลิกโดยเฉพาะ)', 'บันทึกเงินเข้า-ออกระหว่างกะ', 'ปิดกะและพิมพ์ Z-Report']],
                    ['label' => 'ศูนย์ควบคุม POS', 'route' => 'pos.control', 'purpose' => 'ผู้จัดการ/สำนักงานดูภาพรวมยอดขาย POS ทุกเครื่อง ทุกกะ แบบเรียลไทม์', 'actions' => ['หน้าดูอย่างเดียว ไม่มีการบันทึกข้อมูลที่นี่']],
                    ['label' => 'เครื่องมือ POS', 'route' => 'bplus.pos-workbench', 'purpose' => 'เครื่องมือเสริมของทีมหลังบ้านสำหรับจัดการ POS ในกรณีพิเศษ', 'actions' => ['ใช้ตามที่หน้าจอแสดง (เครื่องมือเฉพาะกิจของทีมหลังบ้าน)']],
                    ['label' => 'ส่งข้อมูลไป POS', 'route' => 'bplus.pos-preparation', 'purpose' => 'เตรียม/ส่งข้อมูลสินค้า ราคา และโปรโมชั่นไปยังเครื่อง POS แต่ละสาขา', 'actions' => ['ตั้งค่าและส่งชุดข้อมูลไปยัง POS']],
                    ['label' => 'QR รับเงิน / จอแสดงราคา', 'route' => 'bplus.qr-payments', 'purpose' => 'ตั้งค่า QR PromptPay รับเงินหน้าร้าน และจอแสดงราคาสินค้าเวลาสแกน', 'actions' => ['เพิ่ม/แก้ไข/ลบการตั้งค่า QR รับเงิน', 'ตั้งค่าจอแสดงราคา']],
                ],
            ],
            [
                'key' => 'material', 'label' => 'คลัง / ผลิต / ซื้อ', 'icon' => 'bi-box-seam-fill',
                'items' => [
                    ['label' => 'สินค้า / บริการ', 'route' => 'products.index', 'purpose' => 'ทะเบียนสินค้ากลาง ราคา บาร์โค้ด หน่วยนับ และการตรวจสอบคุณภาพ/Lot', 'actions' => ['เพิ่ม/แก้ไขสินค้า', 'เพิ่มบาร์โค้ด', 'ตั้งราคาขาย และราคาเฉพาะช่วงเวลาสำหรับ POS', 'ผูกผู้ขาย + ราคาซื้อของแต่ละผู้ขาย', 'ตรวจสอบย้อนกลับ Lot (ซื้อมาจากไหน ขายไปที่ไหนบ้าง)', 'พักกักกัน/ปรับสถานะคุณภาพของ Lot', 'เปิดเคสเรียกคืนสินค้า (recall)']],
                    ['label' => 'โอนย้าย / ปรับยอดสต๊อก', 'route' => 'stock-transfers.index', 'purpose' => 'โอนสินค้าระหว่างสาขา/คลัง และปรับยอดสต๊อกให้ตรงกับของจริง', 'actions' => ['สร้างใบโอนสินค้า', 'อนุมัติ / ไม่อนุมัติใบโอน', 'ตรวจรับปลายทางด้วยการสแกนบาร์โค้ด แล้วเทียบกับยอดในใบโอน (เพิ่งเปิดใช้งานใหม่)', 'สร้างใบปรับยอดสต๊อก + อนุมัติ/ไม่อนุมัติพร้อมเหตุผล']],
                    ['label' => 'ขอโอนสินค้า', 'route' => 'stock-transfers.request', 'purpose' => 'สาขาที่ต้องการสินค้าเพิ่มยื่นคำขอโอนจากสาขา/คลังอื่น', 'actions' => ['กรอกรายการที่ต้องการแล้วส่งคำขอโอน']],
                    ['label' => 'แนะนำเติมสินค้าสาขา', 'route' => 'stock-transfers.replenishment.index', 'purpose' => 'ระบบคำนวณแนะนำว่าสาขาไหนควรเติมสินค้าอะไรเท่าไร จากยอดขาย สต๊อกคงเหลือ และคำขอโอนที่รออยู่แล้ว (ฟีเจอร์ใหม่)', 'actions' => ['เลือกรายการที่ระบบแนะนำแล้วกดสร้างเป็นใบขอโอนอัตโนมัติ']],
                    ['label' => 'ตรวจนับสินค้า', 'route' => 'stock-counts.index', 'purpose' => 'นับสต๊อกจริงเทียบกับยอดในระบบ', 'actions' => ['สร้างรอบตรวจนับ', 'กรอก/บันทึกยอดที่นับได้', 'นำเข้า-ส่งออกยอดนับเป็นไฟล์', 'ส่งผลตรวจนับ', 'โพสต์ผลต่างเป็นใบปรับสต๊อก']],
                    ['label' => 'เบิก / คืน / สูญเสีย / แปรรูป', 'route' => 'stock-issues.index', 'purpose' => 'เบิกวัตถุดิบไปใช้ คืนของ บันทึกของเสีย และแปรรูปสินค้าแบบชั่งน้ำหนัก', 'actions' => ['สร้างใบเบิก/คืน/สูญเสีย + อนุมัติ/ไม่อนุมัติ', 'สร้างรอบแปรรูป + เพิ่มถุง/แพ็กที่ได้ + พิมพ์ป้ายชั่ง']],
                    ['label' => 'การผลิต', 'route' => 'production.index', 'purpose' => 'ตั้งสูตรผลิต (BOM) สร้างใบสั่งผลิต และรับผลผลิตเข้าคลัง', 'actions' => ['เพิ่ม/แก้สูตรผลิต และรายการวัตถุดิบในสูตร', 'สร้าง/แก้ใบสั่งผลิต', 'รับสินค้าที่ผลิตได้เข้าคลัง', 'ปิดงานด้วยมือเมื่อผลิตได้น้อยกว่าแผน ต้องกรอกเหตุผลเสมอ (ฟีเจอร์ใหม่)']],
                    ['label' => 'รายงานประสิทธิภาพผลิต', 'route' => 'production.efficiency', 'purpose' => 'เทียบแผนกับจริงของใบสั่งผลิต (ต้นทุนและปริมาณ) และสรุป yield/margin ของงานแปรรูป (ฟีเจอร์ใหม่)', 'actions' => ['กรองช่วงวันที่และสาขา (หน้าดูอย่างเดียว ไม่มีปุ่มบันทึก)']],
                    ['label' => 'ใบขอซื้อ / ใบสั่งซื้อ', 'route' => 'purchase-orders.index', 'purpose' => 'ขอราคาผู้ขาย ออกใบสั่งซื้อ (PO) และติดตามการรับสินค้าตาม PO', 'actions' => ['ขอราคาจากผู้ขายหลายราย + เลือกราคาที่จะใช้', 'สร้างใบสั่งซื้อ', 'อนุมัติ PO', 'ยืนยันสั่งซื้อจริงกับผู้ขาย', 'รับสินค้าตาม PO', 'ยกเลิก PO', 'พิมพ์ PO']],
                    ['label' => 'รับสินค้าเข้าจากผู้ขาย', 'route' => 'purchases.index', 'purpose' => 'บันทึกรับสินค้าเข้าคลังจากผู้ขาย ตัดเป็น Lot พร้อมต้นทุนจริง', 'actions' => ['สร้างใบซื้อ (รับเข้าคลังทันที)', 'ปรับต้นทุนซื้อย้อนหลังถ้ากรอกราคาผิดตอนรับของ (ฟีเจอร์ใหม่ ต้องมีสิทธิ์เฉพาะ)']],
                    ['label' => 'OCR รับสินค้า (Draft)', 'route' => 'ocr.documents.index', 'purpose' => 'อัปโหลดรูปใบส่งของผู้ขายให้ระบบอ่านด้วย OCR แล้วแปลงเป็นใบรับสินค้าโดยไม่ต้องคีย์เอง', 'actions' => ['อัปโหลดไฟล์/รูปใบส่งของ', 'สั่งประมวลผล OCR', 'แก้ไขข้อมูลที่อ่านผิด', 'อนุมัติ / ไม่อนุมัติ', 'โพสต์เป็นใบรับสินค้าจริงเข้าคลัง']],
                    ['label' => 'คลังมือถือ (สแกน)', 'route' => 'wh.index', 'purpose' => 'หน้าจอมือถือสำหรับพนักงานคลังค้นหาสินค้า/ตรวจสต๊อก/รับของด้วยการสแกน', 'actions' => ['ค้นหาสินค้าด้วยบาร์โค้ด', 'ดูยอดคงเหลือ', 'รับสินค้าเข้า', 'ดู/รับสินค้าตามใบสั่งซื้อ']],
                    ['label' => 'เติมเต็ม / แผนจัดซื้อ', 'route' => 'bplus.purchase-planning', 'purpose' => 'วางแผนสั่งซื้อล่วงหน้าตามยอดขาย/สต๊อกขั้นต่ำ', 'actions' => ['สร้างแผนจัดซื้อ', 'สร้างใบขอซื้อจากแผนที่วางไว้']],
                ],
            ],
            [
                'key' => 'money', 'label' => 'การเงิน / บัญชี', 'icon' => 'bi-calculator-fill',
                'items' => [
                    ['label' => 'บัญชีครบวงจร', 'route' => 'accounting-automation.index', 'purpose' => 'ระบบบัญชีอัตโนมัติ: ตั้งกฎรายการที่เกิดซ้ำประจำ และนำเข้าข้อมูลบัญชีเป็นชุด', 'actions' => ['ตั้งกฎรายการประจำ + สั่งรันตามกฎ', 'อัปโหลดไฟล์นำเข้า + ตรวจทานก่อนบันทึกจริง']],
                    ['label' => 'ผังบัญชี / บันทึกบัญชี', 'route' => 'chart-of-accounts.index', 'purpose' => 'ผังบัญชีกลางและสมุดรายวันทั่วไป (GL) ของกิจการ', 'actions' => ['เพิ่ม/แก้บัญชีในผังบัญชี', 'นำเข้าผังบัญชีเป็นไฟล์', 'ดูรายการ GL (เกิดอัตโนมัติจากเอกสารต้นทางเท่านั้น ห้ามคีย์รายการ GL มือ)']],
                    ['label' => 'งวดบัญชี / ปิดงวด', 'route' => 'accounting-periods.index', 'purpose' => 'กำหนดช่วงเวลาบัญชีและล็อกไม่ให้แก้เอกสารย้อนหลังหลังปิดงวด', 'actions' => ['สร้างงวดบัญชีใหม่', 'ปิดงวด', 'เปิดงวดที่ปิดแล้วกลับมาแก้ไข (ควรมีเหตุผลชัดเจนทุกครั้ง)']],
                    ['label' => 'ปิดบัญชีรายเดือน', 'route' => 'monthly-accounting.index', 'purpose' => 'รวมค่าใช้จ่าย กระทบยอด statement ธนาคาร แล้วส่งออกชุดไฟล์ให้สำนักงานบัญชี', 'actions' => ['บันทึกค่าใช้จ่าย', 'นำเข้า statement ธนาคาร', 'จับคู่รายการอัตโนมัติ หรือจับคู่เอง', 'ส่งออกชุดไฟล์ + ดาวน์โหลด']],
                    ['label' => 'ภาษีไทย / E-Tax', 'route' => 'tax-compliance.index', 'purpose' => 'เตรียมยื่นภาษี (เช่น ภ.พ.30) และจัดการ e-Tax invoice', 'actions' => ['เตรียมยื่นภาษีงวด + ตรวจทาน + ยืนยันยื่นจริง + ดาวน์โหลดไฟล์ยื่น', 'เตรียม e-Tax + อัปเดตสถานะ']],
                    ['label' => 'งบการเงิน', 'route' => 'financial-statements.index', 'purpose' => 'ดูงบทดลอง งบกำไรขาดทุน และงบดุล คำนวณจาก GL โดยตรง', 'actions' => ['หน้าดูอย่างเดียว ไม่มีปุ่มบันทึกข้อมูล']],
                    ['label' => 'ทะเบียนทรัพย์สิน', 'route' => 'fixed-assets.index', 'purpose' => 'ทะเบียนทรัพย์สินถาวรและค่าเสื่อมราคา', 'actions' => ['ลงทะเบียนทรัพย์สินใหม่', 'รันค่าเสื่อมราคาประจำงวด', 'ขาย/ตัดจำหน่ายทรัพย์สิน']],
                    ['label' => 'เงินสด / ภาษี', 'route' => 'bplus.finance', 'purpose' => 'บันทึกสมุดเงินสด/ธนาคาร และตั้งอัตราภาษี', 'actions' => ['บันทึกรายการสมุดเงินสด', 'ตั้งอัตรา VAT']],
                    ['label' => 'บัญชีธนาคาร', 'route' => 'bank-accounts.index', 'purpose' => 'ทะเบียนบัญชีธนาคารของกิจการ', 'actions' => ['เพิ่ม/แก้บัญชีธนาคาร']],
                    ['label' => 'ฝาก/ถอนเงินสด', 'route' => 'cash-transfers.index', 'purpose' => 'บันทึกนำเงินสดฝากธนาคาร ถอนมาใช้ หรือโอนระหว่างบัญชี', 'actions' => ['บันทึกรายการฝาก-ถอน-โอนเงิน']],
                    ['label' => 'ทะเบียนเช็ค', 'route' => 'cheques.index', 'purpose' => 'ติดตามเช็ครับและเช็คจ่ายตั้งแต่ได้รับจนขึ้นเงินสำเร็จ', 'actions' => ['บันทึกเช็คใหม่', 'นำฝากเช็ค', 'ทำเครื่องหมายผ่านแล้ว/ขึ้นเงินสำเร็จ', 'ทำเครื่องหมายเช็คเด้ง/คืน', 'ยกเลิกเช็ค']],
                    ['label' => 'อนุมัติเอกสาร', 'route' => 'bplus.approvals', 'purpose' => 'ศูนย์กลางอนุมัติเอกสารที่รออนุมัติข้ามหลายโมดูล', 'actions' => ['บันทึกผลอนุมัติ/ไม่อนุมัติ']],
                ],
            ],
            [
                'key' => 'man', 'label' => 'ข้อมูลตั้งต้น', 'icon' => 'bi-people-fill',
                'items' => [
                    ['label' => 'ศูนย์ตั้งต้นระบบ', 'route' => 'master-data-setup.index', 'purpose' => 'นำเข้าข้อมูลตั้งต้นจำนวนมากด้วยไฟล์ เช่น ตอนเปิดระบบใหม่หรือย้ายข้อมูล', 'actions' => ['ดาวน์โหลดไฟล์ template', 'อัปโหลดดูตัวอย่างก่อนบันทึกจริง', 'ยืนยันบันทึกเข้าระบบจริง']],
                    ['label' => 'ลูกค้า (รวมลูกหนี้)', 'route' => 'customers.index', 'purpose' => 'ทะเบียนลูกค้าและวงเงินเครดิต', 'actions' => ['เพิ่ม/แก้ข้อมูลลูกค้า', 'เพิ่มที่อยู่/ผู้ติดต่อ', 'บันทึกรับชำระจากลูกค้า', 'อนุมัติ / ไม่อนุมัติวงเงินเครดิต']],
                    ['label' => 'ผู้จำหน่าย / เจ้าหนี้', 'route' => 'suppliers.index', 'purpose' => 'ทะเบียนผู้ขายและเงื่อนไขการซื้อ', 'actions' => ['เพิ่ม/แก้ข้อมูลผู้จำหน่าย', 'เพิ่มที่อยู่', 'บันทึกจ่ายเงินให้ผู้ขาย']],
                    ['label' => 'สมาชิก', 'route' => 'members.index', 'purpose' => 'ทะเบียนสมาชิกร้าน (คนละส่วนกับลูกค้าเครดิต)', 'actions' => ['เพิ่ม/แก้ข้อมูลสมาชิก']],
                    ['label' => 'คลังสินค้า', 'route' => 'warehouse-locations.index', 'purpose' => 'กำหนดคลังและตำแหน่งจัดเก็บในแต่ละสาขา', 'actions' => ['เพิ่ม/แก้คลังและตำแหน่งจัดเก็บ']],
                    ['label' => 'ตารางราคา', 'route' => 'price-tables.index', 'purpose' => 'กำหนดราคาขายเป็นชุดแล้วผูกเข้าสาขาที่ต้องการ', 'actions' => ['สร้างตารางราคา', 'กำหนดราคาต่อสินค้าในตาราง', 'ผูกตารางราคาเข้าสาขา']],
                    ['label' => 'ราคาเครื่องชั่ง', 'route' => 'scale-prices.index', 'purpose' => 'ตั้งราคาสินค้าชั่งน้ำหนัก (PLU) เพื่อส่งเข้าเครื่องชั่งดิจิทัล', 'actions' => ['แก้ราคาต่อ PLU', 'ผูกรหัส PLU กับสินค้า', 'ส่งออกไฟล์ให้เครื่องชั่ง']],
                    ['label' => 'โปรโมชั่น', 'route' => 'promotions.index', 'purpose' => 'ตั้งโปรโมชั่นส่วนลดทั่วไป', 'actions' => ['เพิ่ม/แก้โปรโมชั่น']],
                    ['label' => 'ราคานาทีทอง', 'route' => 'flash-sales.index', 'purpose' => 'ตั้งราคาพิเศษในช่วงเวลาสั้นๆ', 'actions' => ['สร้างแคมเปญนาทีทอง', 'เพิ่ม/ลบสินค้าในแคมเปญ']],
                    ['label' => 'ป้ายราคา', 'route' => 'price-tags.index', 'purpose' => 'พิมพ์ป้ายราคาติดหน้าร้าน', 'actions' => ['เพิ่มรูปแบบป้าย', 'ดูตัวอย่างก่อนพิมพ์', 'สั่งพิมพ์']],
                    ['label' => 'บัตรส่วนลด', 'route' => 'discount-cards.index', 'purpose' => 'ออกบัตรหรือโค้ดส่วนลด', 'actions' => ['สร้างบัตรส่วนลด', 'ตรวจสอบบัตรก่อนใช้งานจริง']],
                    ['label' => 'แต้มสมาชิก', 'route' => 'member-points.index', 'purpose' => 'ตั้งกฎการให้แต้มสะสมของสมาชิก', 'actions' => ['เพิ่ม/แก้กฎการให้แต้ม']],
                    ['label' => 'แคมเปญซื้อครบ', 'route' => 'qty-promotions.index', 'purpose' => 'ตั้งโปรโมชั่นซื้อครบจำนวน/ยอดแล้วได้ของแถมหรือส่วนลด', 'actions' => ['เพิ่ม/แก้แคมเปญซื้อครบ']],
                ],
            ],
            [
                'key' => 'integrations', 'label' => 'เชื่อมต่อ', 'icon' => 'bi-plug-fill',
                'items' => [
                    ['label' => 'LINE แจ้งเตือน', 'route' => 'line-integrations.index', 'purpose' => 'ตั้งค่าส่งแจ้งเตือนเข้า LINE เช่น แจ้งยอดขายหรือสต๊อกต่ำ', 'actions' => ['เพิ่ม/แก้การเชื่อมต่อ LINE']],
                    ['label' => 'E-Commerce', 'route' => 'ecommerce-channels.index', 'purpose' => 'ตั้งค่าเชื่อมต่อช่องทางขายออนไลน์', 'actions' => ['เพิ่ม/แก้ช่องทาง e-commerce']],
                ],
            ],
            [
                'key' => 'reports', 'label' => 'รายงาน', 'icon' => 'bi-clipboard-data-fill',
                'items' => [
                    ['label' => 'ภาพรวมผู้บริหาร', 'route' => 'executive.index', 'purpose' => 'แดชบอร์ดสรุปสำหรับผู้บริหาร', 'actions' => ['หน้าดูอย่างเดียว ไม่มีปุ่มบันทึกข้อมูล']],
                    ['label' => 'ศูนย์รวมรายงาน / รายงานขาย / ซื้อ / คลัง / บัญชี / ภาษี', 'route' => 'reports.index', 'purpose' => 'รวมรายงานทุกหมวดไว้ที่เดียว เมนูย่อยแต่ละอันแค่กรองมาคนละหมวดจากหน้าเดียวกัน', 'actions' => ['กรองช่วงวันที่/สาขา/หมวดรายงาน', 'ส่งออกรายงานเป็นไฟล์ (จำกัดจำนวนแถวต่อการส่งออกหนึ่งครั้ง)']],
                    ['label' => 'รายงาน BPlus เดิม', 'route' => 'legacy-reports.index', 'purpose' => 'เข้าถึงรายงานจากระบบเดิม (BPlus) ที่ยังไม่ได้ย้ายมาทำใหม่ใน ERP', 'actions' => ['หน้าดูอย่างเดียว ไม่มีปุ่มบันทึกข้อมูล']],
                ],
            ],
            [
                'key' => 'system', 'label' => 'ระบบ', 'icon' => 'bi-gear-fill',
                'items' => [
                    ['label' => 'ตั้งค่าระบบ', 'route' => 'settings.index', 'purpose' => 'ตั้งค่ากลางของ ERP เช่น ข้อมูลบริษัท เลขที่เอกสาร รวมถึง POS Designer และ POS Build', 'actions' => ['บันทึกการตั้งค่าทั่วไป', 'จัดเรียงลำดับเมนู', 'ออกแบบหน้าจอ POS', 'ตั้งค่าว่ารายงานไหนแสดงให้ใครดู', 'ออก/หมุนเวียน POS token (ผ่านตัวช่วยของระบบเท่านั้น ไม่กรอกรหัสตรงๆ)', 'อัปเดตข้อมูลฮาร์ดแวร์ POS terminal', 'เผยแพร่ POS build เวอร์ชันใหม่', 'สร้าง/รีเฟรช POS build', 'แก้ไขหมวดหมู่ของ module controls', 'แก้ไขแม่แบบใบเสร็จ']],
                    ['label' => 'ตั้งค่า Workflow เอกสาร', 'route' => 'settings.workflows', 'purpose' => 'กำหนดขั้นตอนอนุมัติของเอกสารแต่ละประเภท', 'actions' => ['แก้ไขขั้นตอน/ผู้อนุมัติของ workflow']],
                    ['label' => 'Backup / Security', 'route' => 'operations.index', 'purpose' => 'สำรองข้อมูลและงานด้านความปลอดภัยของระบบ', 'actions' => ['สั่งสำรองข้อมูล', 'ตรวจสอบว่ากู้คืนจากไฟล์สำรองได้จริง', 'รีเซ็ต MFA ให้ผู้ใช้']],
                    ['label' => 'โครงสร้างฐานข้อมูล', 'route' => 'database-structure.index', 'purpose' => 'ดูโครงสร้างตารางและความสัมพันธ์ในฐานข้อมูล สำหรับทีม IT/นักพัฒนา', 'actions' => ['หน้าดูอย่างเดียว ไม่มีปุ่มบันทึกข้อมูล']],
                    ['label' => 'Mapping Bplus → ERP', 'route' => 'legacy-mappings.index', 'purpose' => 'ดูการจับคู่ตาราง/ฟิลด์ระหว่างระบบเดิมกับ ERP ใหม่', 'actions' => ['หน้าดูอย่างเดียว ไม่มีปุ่มบันทึกข้อมูล']],
                    ['label' => 'สมุดเอกสาร', 'route' => 'document-books.index', 'purpose' => 'แยกเอกสารประเภทเดียวกันเป็นหลายเล่ม เช่น ขายเชื่อสาขา 1 เล่ม A สาขา 2 เล่ม B เพื่อให้เลขที่วิ่งแยกกัน', 'actions' => ['เพิ่ม/แก้เล่มเอกสาร']],
                    ['label' => 'ผู้ใช้และสิทธิ์', 'route' => 'users.index', 'purpose' => 'จัดการผู้ใช้งานและสิทธิ์การเข้าถึงระบบ', 'actions' => ['เพิ่ม/แก้ผู้ใช้และสิทธิ์', 'รีเซ็ตรหัสผ่าน', 'รีเซ็ต POS PIN ให้ผู้ใช้ (ระบบรีเซ็ตให้เท่านั้น ห้ามตั้งค่า PIN แทนผู้ใช้โดยตรง)', 'ปรับสาขา POS ให้ตรงกับผู้ใช้']],
                    ['label' => 'ผังองค์กร', 'route' => 'organizational-units.index', 'purpose' => 'กำหนดโครงสร้างหน่วยงานและสายบังคับบัญชา', 'actions' => ['เพิ่ม/แก้/ลบหน่วยงาน', 'มอบหมายพนักงานเข้าหน่วยงาน หรือถอดออก']],
                ],
            ],
        ];
    }
