    ...
    private function workflows(): array
    {
        return [
            ...
            [
                ...
                'goal' => 'เบิกวัตถุดิบตามสูตร รับผลผลิตจริง และเห็นผลต่าง/ต้นทุนต่อรอบผลิต',
                'steps' => [
                    ['ตั้งสูตร', 'production.index', 'กำหนดผลผลิต วัตถุดิบ และอัตราใช้'],
                    ['เปิดใบสั่งผลิต', 'production.index', 'กำหนดจำนวน สาขา คลัง และวันผลิต'],
                    ['เบิกวัตถุดิบ', 'stock-issues.index', 'ตัด Lot วัตถุดิบด้วยเอกสาร DR'],
                    ['บันทึกผลผลิต', 'production.index', 'รับสินค้าสำเร็จรูปด้วยเอกสาร IP'],
                    ['บันทึกสูญเสีย', 'stock-issues.index', 'ตัดชำรุด/ของเสียพร้อมเหตุผล'],
                    ['ตรวจผลต่าง', 'reports.index', 'เทียบสูตร ใช้จริง ผลผลิต และต้นทุน'],
                ],
            ],
            [
